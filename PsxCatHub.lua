...
task.wait(1)
AddNotification("Thx For Using Cat Hub V2.1")
wait(3)

local v1 = require(game.ReplicatedStorage:WaitForChild("Framework"):WaitForChild("Library"))

v1.Signal.Fire("Notification", "Thx For Using Cat Hub v2.1", {
  color = Color3.fromRGB(0, 255, 255)
});
--Main System | Update
local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/shlexware/Orion/main/source')))()
local Window = OrionLib:MakeWindow({Name = "Cat Hub V2.1", HidePremium = true, SaveConfig = true, ConfigFolder = "Cat Hub V2.1", IntroEnabled = true, IntroText = "Cat Hub|Loader",IntroIcon = "rbxassetid://10472045394", Icon = "rbxassetid://10472045394" })
--Player Info | Update
